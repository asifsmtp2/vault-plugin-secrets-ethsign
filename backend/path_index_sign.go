...
func pathSignIndex(b *backend) *framework.Path {
	return &framework.Path{
		Pattern:      "index/" + framework.GenericNameWithAtRegex("index") + "/" + framework.GenericNameRegex("name") + "/sign",
    ...
    `,
		...
		Callbacks: map[logical.Operation]framework.OperationFunc{
			logical.CreateOperation: b.signIndexTx,
		},
	}
}
